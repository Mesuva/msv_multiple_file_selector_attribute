...
if (!empty($values)) {
    foreach ($values as $file) {
        ...
        echo '<li class="list-group-item"><i class="fa fa-arrows-v"></i>' . $thumb . ' ' . $file->getTitle() . '<a><i class="pull-right fa fa-minus-circle"></i></a><input type="hidden" name="' . $this->field('value') . '[]" value="' . $file->getFileID() . '" /></li>';
    }
}
echo '</ul>';
...
echo "<div href=\"#\" id=\"" . $id . "_launch\" data-max-items=\"" . $maxItems . "\" data-launch=\"file-manager\" class=\"ccm-file-selector " . $hide . "\"><div class=\"ccm-file-selector-choose-new\">" . $label . "</div></div>
